...
.PHONY: help onboard up bootstrap verify test-mcp test-bridge bridge-once monitor monitor-full watchdog-once watchdog-loop backup-drill full-check publish-check logs ps down clean
