...
- Added optional task selection filters (`BRIDGE_SKIP_DONE`, `BRIDGE_ALLOWED_BUCKET_IDS`, `BRIDGE_REQUIRED_LABELS`) to reduce noise and process only execution-relevant tasks.
